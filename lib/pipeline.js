...
const STAGES = [
  ...
  { id: 'veins', title: 'Veias', icon: '🩸', model: 'Z-Anatomy vascular + SSS thickness', desc: 'Rede venosa subdérmica visível com retroiluminação (material, não geo grossa)', kind: 'veins', structural: false },
