...
const STAGES = [
  ...
  { id: 'garment', title: 'Tecido', icon: '🪡', model: 'ChatGarment (VLM) → GarmentCode JSON → drape', desc: 'ChatGarment lê N imagens de etapas da roupa, deduz o padrão de costura e drapeia sobre o corpo MPFB2.', kind: 'garment' },
