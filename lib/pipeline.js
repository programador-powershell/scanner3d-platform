...
const STAGES = [
  ...
  { id: 'garment', title: 'Tecido', icon: '🪡', model: 'ChatGarment → GarmentCode → TailorNet', desc: 'ChatGarment lê N imagens das etapas da roupa, deduz o pattern; TailorNet deforma por pose; drape sobre o corpo.', kind: 'garment' },
