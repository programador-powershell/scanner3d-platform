...
const STAGES = [
  { id: 'skeleton', title: 'Esqueleto', icon: '🦴', model: 'ATLAS/MHR (via HSMR)', desc: 'Estrutura óssea osso a osso, proporções, falanges e articulações.', kind: 'skeleton', structural: true },
  { id: 'veins', title: 'Veias', icon: '🩸', model: 'displacement / SSS subdérmico', desc: 'Relevo vascular subdérmico, ramificações e espessura.', kind: 'veins' },
  { id: 'muscle', title: 'Músculos', icon: '💪', model: 'HIT + Chaos Flesh', desc: 'Definição, massa corporal, volume e colisores físicos.', kind: 'muscle', structural: true },
  { id: 'garment', title: 'Tecido', icon: '🪡', model: 'GarmentCode → drape (Warp/Newton)', desc: 'Moldes 2D, caimento inicial e resposta à gravidade.', kind: 'garment' },
  { id: 'skin', title: 'Pele', icon: '🧫', model: 'loop nvdiffrast + micro-normais', desc: 'Textura PBR, poros via micro-normais e especularidade.', kind: 'skin' },
  { id: 'nails', title: 'Unhas', icon: '💅', model: 'material PBR no template', desc: 'Formato, curvatura, cutícula e material especular.', kind: 'nails' },
  { id: 'face', title: 'Rosto', icon: '👤', model: 'FLAME → ICT-FaceKit', desc: 'Topologia facial, loops de animação e linhas de expressão.', kind: 'face' },
  { id: 'eyes', title: 'Olhos', icon: '👁️', model: 'shader córnea / íris', desc: 'Posição da íris, refração da córnea e umidade lacrimal.', kind: 'eyes' },
  { id: 'hair', title: 'Cabelo', icon: '💇', model: 'DiffLocks → Groom', desc: 'Curvas-guia vetoriais, strand count e balanço físico.', kind: 'hair' },
];
