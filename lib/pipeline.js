...
const STAGES = [
  ...
  { id: 'muscle', title: 'Músculos', icon: '💪', model: 'TailorMe (instanciado) + SKEL + NDG', desc: 'Músculo INSTANCIADO (malha real, não campo implícito) deformado com a pose; colisor físico.', kind: 'muscle', structural: true },
  { id: 'garment', title: 'Tecido', icon: '🪡', model: 'ChatGarment → GarmentCode → Warp → Newton', desc: 'ChatGarment lê N imagens das etapas; GarmentCode gera o pattern; drape físico Warp/Newton VBD multicamada.', kind: 'garment' },
  { id: 'skin', title: 'Pele', icon: '🧫', model: 'Material AI (Hunyuan/RGB↔X) + bake + SSS', desc: 'Albedo/normal/rough/metallic + AO/height/micro-normal/SSS — o material que dá o realismo Stellar Blade.', kind: 'skin' },
  ...
  { id: 'face', title: 'Rosto', icon: '👤', model: 'SMPL-X → FLAME → ARKit 52', desc: 'Cabeça paramétrica FLAME registrada com blendshapes ARKit; topologia de animação.', kind: 'face' },
  ...
  { id: 'hair', title: 'Cabelo', icon: '💇', model: 'DiffLocks + Hair Curves + Geometry Nodes', desc: 'DiffLocks gera ~100K strands da foto; Hair Curves anima; Geometry Nodes faz pelos corporais.', kind: 'hair' },
];
...
function publicJob(job) {
  ...
  return {
    ...
    sourceImages: job.sourceImages || [job.sourceImage],
    scan: job.scan || null,
